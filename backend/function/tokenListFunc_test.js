...
module.exports.getTokenName = async function(address) {
...
module.exports.getTokenSymbol = async function(address) {
    const tokenABI = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../abi/tokenABI.json")));
    let tokenContract = new web3.eth.Contract(tokenABI, address);
...
module.exports.getTotalSupply = async function(address) {
    const tokenABI = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../abi/tokenABI.json")));
    let tokenContract = new web3.eth.Contract(tokenABI, address);
...
getPriceETHV2 = async function(address) {
    // liquidity pools
...
module.exports.getPriceUSDV2 = async function(address) {    
    // pool = USDC, weth
...
module.exports.getPriceETHV3 = async function(address) {
...
module.exports.getPriceUSDV3 = async function(address) {
    let addressUSDC = "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48";
